...
class DeviceVersionsTest extends PHPUnit_Framework_TestCase {
	...
	public function validateCompletelyEmpty() {
		...
		$deviceVersionsRepository = new DeviceVersions($this->logger);
		$msgs = $deviceVersionsRepository->validate(array());
	...
	public function validateInvalidMacAndInvalidVersion() {
		...
		$deviceVersionsRepository = new DeviceVersions($this->logger);
		$msgs = $deviceVersionsRepository->validate(array('mac' => 'invalid', 'version' => 'invalid'));
	...
	public function validateExistingVersion() {
		...
		mkdir(DATA_DIR . '88:88:88:88:88:88', 0775);
		$fileHandle = fopen(DATA_DIR . '88:88:88:88:88:88/info.json', 'w');
		fwrite($fileHandle, '{"type":"type","info":"info"}');
		fclose($fileHandle);

		// create version-folder with valid content
		mkdir(DATA_DIR . '88:88:88:88:88:88/8.8', 0775);
		$fileHandle = fopen(DATA_DIR . '88:88:88:88:88:88/8.8/info.json', 'w');
		fwrite($fileHandle, '{"softwareName":"softwareName","description":"description"}');
		fclose($fileHandle);
	...
	public function validateNoFile() {
		...
		mkdir(DATA_DIR . '99:99:99:99:99:99', 0775);
		$fileHandle = fopen(DATA_DIR . '99:99:99:99:99:99/info.json', 'w');
		fwrite($fileHandle, '{"type":"type","info":"info"}');
		fclose($fileHandle);
		...
		$this->assertTrue(!array_key_exists('mac', $msgs));
	...
	public function validateValid() {
		...
		mkdir(DATA_DIR . '00:00:00:00:00:00', 0775);
		$fileHandle = fopen(DATA_DIR . '00:00:00:00:00:00/info.json', 'w');
		fwrite($fileHandle, '{"type":"type","info":"info"}');
		fclose($fileHandle);
