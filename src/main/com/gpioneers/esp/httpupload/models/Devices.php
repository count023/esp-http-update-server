...
class Devices {
    ...
    public function validate($formData) {
        ...
        } else if ($this->load($formData['mac'])->isExisting()) {
        ...
        // postData contains any deviceInfo
        if (empty($formData['deviceInfo'])) {
            $msgs['deviceInfo'] = 'Keine weiteren Informationen zum ESP angegeben!';
        }
