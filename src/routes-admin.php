...
$app->get('/admin/device/{staMac:[0-9\:]*}/version/{version:[0-9_]*}', '\\com\\gpioneers\\esp\\httpupload\\controllers\\DeviceVersion:read');

// POST /admin/device/{STA-Mac}/version/{version} -> validate AP-Mac & infoPurposeLocation => INSERT / UPDATE Data for specific ESP -> if UPDATE, remove all stored image.bin files and versions
$app->post('/admin/device/{staMac:[0-9\:]*}/version/{version:[0-9_]*}', '\\com\\gpioneers\\esp\\httpupload\\controllers\\DeviceVersion:update');


// DELETE /admin/device/{STA-Mac}/version/{version} -> deletes image.bin, info.json and version folder
$app->delete('/admin/device/{staMac:[0-9\:]*}/version/{version:[0-9_]*}', '\\com\\gpioneers\\esp\\httpupload\\controllers\\DeviceVersion:delete');
